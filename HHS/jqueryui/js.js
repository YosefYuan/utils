...
/*
	$(function() {
		...
		$("#showposi").css({"left":"200px","top":e.pageY});
		 $("#showposi").show();
		 thistop = $(this).css("top");thisleft = $(this).css("left");
		  thisw = $(this).css("width"); thish = $(this).css("height");
		  
		 curposiv="#"+$(this).attr("id")+'{top:'+thistop+';left:'+thisleft+';wdith:'+thisw+';height:'+thish+';}';
...
//这是百分比的：
	...
	$(function() {
				...
				$(".dragable").dblclick(function(e) {
					...
					curposiv = 'position:absolute;top:' + cur_top + '%;left:' + cur_left + '%;width:' + cur_w + '%;height:' + cur_h + '%';
					$("#showposivalue").val(curposiv);
